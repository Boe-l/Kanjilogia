...
class GameMainState extends State<GameMain> {
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(20),
                        borderSide: BorderSide(
                            color: Color.fromARGB(255, 109, 33, 223), width: 2),
                      ),
                    ),
                            ...
                            child: AnimationLimiter(
                              child: GridView.builder(
                                ...
                                gridDelegate:
                                  ...
                                  crossAxisCount: screenWidth < 320 ? 2 : 3,
                                  crossAxisSpacing: 16,
                                  mainAxisSpacing: 16,
                                ),
                                ...
                                itemBuilder: (context, index) {
                                  final fileName =
                                      _filteredJsonFiles.keys.elementAt(index);
                                  ...
                                  return MouseRegion(
                                    ...
                                    child: AnimationConfiguration.staggeredGrid(
                                      ...
                                      position: index,
                                      columnCount: screenWidth < 320 ? 2 : 3,
                                      duration:
